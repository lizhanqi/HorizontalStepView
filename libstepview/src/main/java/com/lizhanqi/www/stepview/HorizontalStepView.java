...
/*       View rootView = LayoutInflater.from(getContext()).inflate(R.layout.widget_horizontal_stepsview, this);
     ...
     * @param step
     */
    public HorizontalStepView setComplete(int... step){
        if (completeSteps!=null){
            completeSteps.clear();
        }else {
     ...
     * @param steps
     */
    public HorizontalStepView setComplete(ArrayList<Integer> steps){
        steps.clear();
        completeSteps=steps;
        mComplectingPosition=-1;
                ...
                textView.setTextSize(textSize);
                    if (i==0){
                        ...
                        if (mStepsViewIndicator.fixPointPadding){
                            ...
                            textView.setX(mStepsViewIndicator.getWidth() - (mTexts.get(i).length()* textView.getTextSize()));
                        }
                    }else{
