package com.lizhanqi.www.stepview;
...
public void imaginaryLine(boolean imaginaryLine){
    ...
    private void init()
    {
        ...
        mCompleteIcon = getResources().getDrawable( R.drawable.complted);//已经完成的icon
        mAttentionIcon = getResources().getDrawable( R.drawable.attention);//正在进行的icon
        mDefaultIcon = getResources().getDrawable( R.drawable.default_icon);//未完成的icon
    }
